...
using hjwallpaper.Areas.Admin.Models;
using System.Data;
using System.IO;
...
namespace hjwallpaper.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            if (reader.HasRows)
            {
                ...
                while (reader.Read())
                {
                    ...
                    cateModel.caID = reader.GetInt32(0);
        ...
        public ActionResult AddJson(HttpPostedFileBase fileUp, string title)
        {
            ...
            //根据时间生成文件夹路径
            string dir = "/Public/UpLoad/Images/Category/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + DateTime.Now.Day + "/";
